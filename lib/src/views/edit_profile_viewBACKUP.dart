...
class _EditProfileViewState extends State<EditProfileView> {
        ...
        child: Column(children: [
          ...
          Row(
            ...
            children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image:
                                Image.asset("./assets/images/clintokLogo.jpeg")
                                    .image,
                            fit: BoxFit.fill)),
                    child: Container(
              ...
              //       radius: 50,
              //       backgroundImage:
              //           Image.asset("../assets/images/clintokLogo.jpeg").image,
              //       child: Container(
              //         height: double.infinity,
              //         width: double.infinity,
          ...
          Column(
            children: [
              _buildDetailsAndLabels("Name", "Jacob West"),
              SizedBox(height: 40),
              _buildDetailsAndLabels("Username", "jacob_w"),
              SizedBox(height: 40),
              _buildDetailsAndLabels("TikTok", "tiktok.com@jacob_w"),
              SizedBox(height: 40),
              _buildDetailsAndLabels("Bio", "Add a bio to your profile"),
              SizedBox(height: 40),
              _buildDetailsAndLabels(
                  "Instagram", "Add Instagram to your profile"),
              SizedBox(height: 40),
              _buildDetailsAndLabels("YouTube", "Add YouTube to your profile"),
            ],
          )
        ]),
      ),
  ...
  Row _buildDetailsAndLabels(String key, String value) {
    return Row(
      children: [
        Text(
          key,
        ...
        Icon(Icons.chevron_right, color: Color(0xff86878B))
      ],
    );
  }
}
...
//                                                                           enableRotation:
//                                                                               true,
//                                                                           imageProvider: CachedNetworkImageProvider((_userProfile.largeProfilePic.toLowerCase().contains(".jpg") || _userProfile.largeProfilePic.toLowerCase().contains(".jpeg") || _userProfile.largeProfilePic.toLowerCase().contains(".png") || _userProfile.largeProfilePic.toLowerCase().contains(".gif") || _userProfile.largeProfilePic.toLowerCase().contains(".bmp") || _userProfile.largeProfilePic.toLowerCase().contains("fbsbx.com") || _userProfile.largeProfilePic.toLowerCase().contains("googleusercontent.com"))
...
//                                                 color: settingRepo.setting.value
//                                                     .dpBorderColor!,
//                                                 width: 5.0,
//                                               ),
//                                             ),
...
//                                                           ? _userProfile
//                                                               .smallProfilePic
//                                                           : '${GlobalConfiguration().get('base_url')}' +
//                                                               "default/user-dummy-pic.png",
//                                                     ),
//                                                     fit: BoxFit.cover,
//                                                   ),
//                                                   borderRadius:
...
//                                                                                 PhotoView(
//                                                                               enableRotation: true,
//                                                                               imageProvider: CachedNetworkImageProvider((_userProfile.largeProfilePic.toLowerCase().contains(".jpg") || _userProfile.largeProfilePic.toLowerCase().contains(".jpeg") || _userProfile.largeProfilePic.toLowerCase().contains(".png") || _userProfile.largeProfilePic.toLowerCase().contains(".gif") || _userProfile.largeProfilePic.toLowerCase().contains(".bmp") || _userProfile.largeProfilePic.toLowerCase().contains("fbsbx.com") || _userProfile.largeProfilePic.toLowerCase().contains("googleusercontent.com")) ? _userProfile.largeProfilePic : '${GlobalConfiguration().get('base_url')}' + "default/user-dummy-pic.png"),
//                                                                             ),
//                                                                           ));
//                                                                     }));
//                                                                     Navigator.of(
