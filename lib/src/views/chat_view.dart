...
class ChatView extends StatefulWidget {
  ...
  const ChatView({super.key, this.userObj});
...
class _ChatViewState extends State<ChatView> {
  ...
  BoxDecoration yourDeco = BoxDecoration(
      color: Color(0xffD0D1D3),
      borderRadius: BorderRadius.only(
        bottomLeft: Radius.circular(16),
        bottomRight: Radius.circular(16),
          ...
          children: [
            Container(
              ...
              child: Column(children: [
                SizedBox(height: 20),
                _buildChatPanelPlusImage(
                    isMe: false, message: " Good Evening!"),
                SizedBox(height: 20),
                _buildChatPanelPlusImage(
                    isMe: false, message: " Good Evening!"),
                SizedBox(height: 20),
                _buildChatPanelWithoutImage(
                    isMe: true, message: " Good Evening!"),
                SizedBox(height: 20),
              ]),
            ),
            Align(
  ...
  Widget _buildChatPanelPlusImage(
      {required String message, required bool isMe}) {
    return Align(
        ...
        children: [
          CircleAvatar(
            backgroundImage: Image.asset(
              "./assets/images/clintokLogo.jpeg",
              fit: BoxFit.cover,
            ).image,
            // child:,
          ),
  ...
  Widget _buildChatPanelWithoutImage(
      {required String message, required bool isMe}) {
    return Container(
      // color: Colors.green,
      child: Align(
  ...
  Widget _buildChatPanel({required String message, required bool isMe}) {
    return Container(
      padding: EdgeInsets.all(10),
      constraints: BoxConstraints(minHeight: 50, minWidth: 100),
      decoration: isMe ? myDeco : yourDeco,
      child: Text(message),
    );
  }
}
